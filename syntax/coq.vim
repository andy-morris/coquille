...
" Records
syn region coqRec        contains=coqRecProfile start="\<Record\|Class\|Instance\>" matchgroup=coqVernacPunctuation end="\.\_s" keepend
syn region coqRecProfile contained contains=coqIdent,coqRecTerm,coqRecBinder matchgroup=coqVernacCmd start="Record\|Class\|Instance" matchgroup=NONE end="\.\_s"
